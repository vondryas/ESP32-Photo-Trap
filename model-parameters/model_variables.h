...
#include "tflite-model/tflite_learn_27.h"
...
size_t ei_dsp_config_26_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_26_axes[] = { 0 };
const uint32_t ei_dsp_config_26_axes_size = 1;
ei_dsp_config_image_t ei_dsp_config_26 = {
    26, // uint32_t blockId
    1, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_26_named_axes, // named axes
    ei_dsp_config_26_named_axes_size, // size of the named axes array
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 26
        ...
        (void*)&ei_dsp_config_26, // pointer to config struct
        ei_dsp_config_26_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_26_axes_size, // number of axes
        1, // version
        nullptr, // factory function
    }
};
const ei_config_tflite_graph_t ei_config_tflite_graph_27 = {
    .implementation_version = 1,
    .model = tflite_learn_27,
    .model_size = tflite_learn_27_len,
    .arena_size = tflite_learn_27_arena_size
};

ei_learning_block_config_tflite_graph_t ei_learning_block_config_27 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_27_inputs[1] = { 26 };
...
const ei_impulse_t impulse_665515_0 = {
    .project_id = 665515,
    .project_owner = "Vysoké učení technické Brno",
    .project_name = "wild animals",
    .impulse_id = 7,
    .impulse_name = "Impulse #2 c (copy)",
    .deploy_version = 13,
...
ei_impulse_handle_t impulse_handle_665515_0 = ei_impulse_handle_t( &impulse_665515_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_665515_0;
